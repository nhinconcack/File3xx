this.config = {
 ...
 version: "1.0.0", 
 hasPermssion: 0,
 credita: "Jukie - Mod by CallmeSun",
...
this.run = async function({ api, event, Users }) {
    ...
    var callback = () => api.sendMessage({body:`🌸 Chúc mừng bạn ${name}, Bot dự đoán tỉ lệ có người yêu của bạn trong năm nay là ${tle}% ❤🌸`,attachment: fs.createReadStream(__dirname + "/cache/5.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/5.jpg")); 
